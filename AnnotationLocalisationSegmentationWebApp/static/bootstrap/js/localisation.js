...
BBoxSelector = class BBoxSelector {
  ...
  constructor(image_frame, options) {
    ...
    this.selector.hide();
    //this.selector.appendTo("#container");
...
this.BBoxAnnotator = class BBoxAnnotator {
  ...
  constructor(options) {
    ...
    this.image_frame = $('<div class="image_frame" id ="testdiv"></div>');
    this.annotator_element.append(this.image_frame);
    //this.annotator_element.appendTo("#container");
  ...
  add_entry(entry) {
    ...
    box_element.appendTo(this.image_frame).css({
      "border": this.border_width + "px solid rgb(0,0,0)",
      "position": "absolute",
      "border-width":"thick",
    ...
    //box_element.appendTo("#container");


    //var html = $('.annotated_bounding_box').html();
  ...
  //  alert(jQuery.data(".annotated_bounding_box"));
