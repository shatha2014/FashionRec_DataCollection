...
*/
  ...
  function render(data, params) {
    var i = xy;
    //alert(i);
    var annotator = new Annotator("static/data/images/resized_image"+"_" +i+".jpg", {
          width: params.width,
          ...
          onload: function () {
            if (data.annotationURLs)
              annotator.import(data.annotationURLs[0]);
            annotator.hide("boundary");
            boundaryFlash();
          },
          onchange: function () {
        ...
        imageLayer = new Layer("static/data/images/resized_image"+"_" +i+".jpg", {
          width: params.width,
          height: params.height
        });
